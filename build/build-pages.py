  ...
  <main id="main">
    ...
    <section class="section section--elevated" id="interest">
      ...
      >
        ...
        <button type="submit" class="tz-form__submit">
          <span class="tz-form__submit-label">Notify me →</span>
          <span class="tz-form__submit-spinner" aria-hidden="true"></span>
        </button>
        <p class="tz-form__success" role="status" aria-live="polite" hidden>
          You're on the list. We'll be in touch the moment registration opens — check your email to confirm.
        </p>
        <p class="tz-form__error" role="alert" aria-live="polite" hidden></p>
      </form>
    </section>
    ...
    <section class="final-cta" id="book-a-call">
      ...
      >
        ...
        <button type="submit" class="tz-form__submit tz-form__submit--large">
          <span class="tz-form__submit-label">Request a call →</span>
          <span class="tz-form__submit-spinner" aria-hidden="true"></span>
        </button>
        <p class="tz-form__success" role="status" aria-live="polite" hidden>
          Got it. We'll reach out at the time you mentioned — usually within one business day. Check your email to confirm we have the right address.
        </p>
        <p class="tz-form__error" role="alert" aria-live="polite" hidden></p>
      </form>
    </section>
